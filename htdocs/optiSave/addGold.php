          ...
          session_start();
           ...
           if (mysqli_connect_errno())
           {
            ...
            $query2=mysqli_query($con, "SELECT * FROM userMembership WHERE username='$session_user'");
              ...
              echo "<div style='margin-left:185px;'";
              echo "<h2>You have signed up for</h2>";
              echo "<h2 style='color:GoldenRod; margin-left:185px;'>Gold Membership!</h2>";
              echo "<br>";
              echo "<a style='margin-left:80px;' href='profile.php' class='button icon fa-arrow-circle-right'>View profile</a>";
              echo "</div>";
              }
              mysqli_close($con);
          ?>
