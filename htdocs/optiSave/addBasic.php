          ...
          session_start();
           ...
           if (mysqli_connect_errno())
           {
            ...
            $query2=mysqli_query($con, "SELECT * FROM userMembership WHERE username='$session_user'");
						// $query3 = "SELECT * FROM userMembership WHERE username='$session_user'";
              ...
              echo "<h2 style='color:DimGrey; margin-left:200px;'>Basic Membership!</h2>";
              echo "<br>";
              echo "<a style='margin-left:100px;' href='profile.php' class='button icon fa-arrow-circle-right'>View profile</a>";
              echo "</div>";
