             ...
             if (mysqli_connect_errno())
             {
              echo "Failed to connect to MySQL: " . mysqli_connect_error();
               ...
               if($row['membership_type']==null){
                 ...
                 echo "
                      <!--Select Option -->
                      <form action='editmemsuccess.php' method='post'>
                        <select name='edit_membership' style='width:60%; margin-top:10px; margin-bottom:10px;margin-left:20px;'>
                          <option value=''>Select Option</option>
                          <option value='Basic'> Basic</option>
                          <option value='Premium'> Premium</option>
                          <option value='Gold'> Gold</option>
                          </select>
                          <button type='submit' class='icon fa-plus-circle' style='margin-left:180px; margin-bottom:20px;' href='editmemsuccess.php'> Add to profile </button>
                          </form>
                          <!-- Bit pay -->
                            <form action='https://test.bitpay.com/checkout' method='post'>
                              ...
                              <input type='image' src='https://test.bitpay.com/img/button-medium.png' style='width:100px; height:40px; margin-left:250px; margin-bottom:20px;' border='1' name='submit' alt='BitPay, the easy way to pay with bitcoins.'>
                            </form>
                            <!-- Bit pay -->
                          ";
               }
